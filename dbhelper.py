  ...
  <body>
    ...
    <div class="header">
      <div class="header-right">
        <div><img src="https://simplicapital-live-bucket.s3.amazonaws.com/sci-surfaces/logo.jpeg" alt="logo"></div>
        <div>
      ...
      <div class="address-section-left">
        <table class="bill-address">
          ...
          <td class="fast-xyz-wrp">
            Cabinetry and Millwork Concepts, Inc.<br />3433 NW 18th St.<br />Topeka,
            KS 66618
          </td>
        </table>
      </div>
      ...
      <table class="billing-info">
        ...
        <table class="purchase-desc-header">
          ...
          <tr class="purchase-item">
            <td>
              Patch existing trash holes in island top, and relocate to customer
              provided locations
            </td>
            <td style="background: #e2e2e2; height: 10px"></td>
            <td>
              Arctic White Polished Pantry Top, Redo Pantry L Shape, Splash and
              Tearout
            </td>
          </tr>
          ...
          <table class="footer">
            ...
            <table class="footer-desc">
              <tr >
                <td class="footer-data" style="width: 18%;">
                  Phone #
                </td>
                <td  class="footer-data" style="width: 25.8%;">
                  E-mail
                </td>
                <td  class="footer-data" style="width: 20.2%;">
                  Web Site
                </td>
                <td  class="footer-data" style="font-size:12px; background-color:transparent;">
                  Down Payment/Credits
                </td>
                <td  class="footer-data" style="width: 15.9%; background-color:transparent; text-align: right;">
                  $0.00
                </td>
              </tr>
              <tr>
                ...
                <td style="font-size:12px  padding: 10px 0px;">rae.selvin@sci-surfaces.com</td>
                <td style="font-size:12px  padding: 10px 0px;">www.sci-surfaces.com</td>
                <th style="font-size: 25px;     padding: 10px 0px;border-right: none;">Balance Due</th>
                <td style="border-left: none;     padding: 10px 5px; text-align: right;">$1,198.00</td>
              </tr>
            </table>
          </table>
        </table>
